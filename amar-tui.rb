...
def show_help
  ...
  help_text += colorize_output("★ DUAL SYSTEM ARCHITECTURE", :subheader) + "\n  " + colorize_output("Modern 3-Tier System", :success) + " - Advanced BODY/MIND/SPIRIT progression\n"
  ...
  help_text += colorize_output("⚔️ MODERN SYSTEM FEATURES", :subheader) + "\n  " + colorize_output("N", :dice) + " - Generate NPC (64+ character types, original weapons)\n"
  ...
  help_text += colorize_output("★ REVOLUTIONARY MAGIC", :subheader) + "\n  • " + "Creative unique spells".fg(165) + " - Blue Fireball, Memory Thief\n"
...
def generate_encounter_old
  ...
  if defined?($Encounters) && $Encounters && !$Encounters.empty?
    encounter_types = $Encounters.keys.sort
    encounter_types.each_with_index do |enc_type, i|
      # Format exactly like original CLI: "number: name".ljust(30)
